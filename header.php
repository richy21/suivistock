...
<head>
    ...
    <title>SUIVI STOCK | Accueil</title>
    <link href="/suivistock/public/dshassets/vendor/fontawesome/css/fontawesome.min.css" rel="stylesheet">
    <link href="/suivistock/public/dshassets/vendor/fontawesome/css/solid.min.css" rel="stylesheet">
    <link href="/suivistock/public/dshassets/vendor/fontawesome/css/brands.min.css" rel="stylesheet">
    <link href="/suivistock/public/dshassets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="/suivistock/public/dshassets/css/master.css" rel="stylesheet">
    <link href="/suivistock/public/dshassets/vendor/flagiconcss/css/flag-icon.min.css" rel="stylesheet">
    <link href="/suivistock/public/dshassets/vendor/datatables/datatables.min.css" rel="stylesheet">
    <link href="/suivistock/public/dshassets/vendor/chartsjs/Chart.min.css" rel="stylesheet">
</head>
...
<div class="wrapper">
    <nav id="sidebar" class="active">
        <div class="sidebar-header">
            <img src="/suivistock/public/dshassets/img/bootstraper-logo.png" alt="bootraper logo" class="app-logo">
        </div>
        <ul class="list-unstyled components text-secondary">
            <li>
                <a href="/suivistock/accueil"><i class="fas fa-home"></i> Dashboard</a>
            </li>
            <li>
                <a href="/suivistock/gerer/produit"><i class="fas fa-file-alt"></i> Produits</a>
            </li>
<!--            <li>-->
        ...
        <nav class="navbar navbar-expand-lg navbar-white bg-white">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <div class="nav-dropdown">
                            <a href="" class="nav-item nav-link dropdown-toggle text-secondary" data-toggle="dropdown"><i class="fas fa-user"></i> <span><?= $_SESSION['nomComplet'] ?></span> <i style="font-size: .8em;" class="fas fa-caret-down"></i></a>
                            <div class="dropdown-menu dropdown-menu-right nav-link-menu">
                                <ul class="nav-list">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <li><a href="/suivistock/controller/user/deconnexion" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
